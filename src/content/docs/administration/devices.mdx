...
<DocsImage src={"/img/devices/koreader-sync"} alt={"KOReader Sync Configuration"} />
### Sync Configuration
...
<DocsImage src={"/img/devices/hardcover-integration"} alt={"Hardcover Integration"} />
### Configuration
...
<DocsImage src={"/img/devices/kobo-integration"} alt={"Kobo Integration Configuration"} />
### Sync Configuration
...
<DocsImage src={"/img/devices/kobo-admin-settings"} alt={"Kobo Administrator Settings"} />
...
:::caution[Conversion Performance]
