...
<ThemeImage src={"/img/devices/koreader-sync.jpg"} alt={"KOReader Sync Configuration"} />
### Sync Configuration
...
<ThemeImage src={"/img/devices/hardcover-integration.jpg"} alt={"Hardcover Integration"} />
### Configuration
...
<ThemeImage src={"/img/devices/kobo-integration.jpg"} alt={"Kobo Integration Configuration"} />
### Sync Configuration
...
<ThemeImage src={"/img/devices/kobo-admin-settings.jpg"} alt={"Kobo Administrator Settings"} />
