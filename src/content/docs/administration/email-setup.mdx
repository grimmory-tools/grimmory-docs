...
<DocsImage src={"/img/email-setup/email-configuration"} alt={"Email Configuration"} />
---
...
<DocsImage src={"/img/email-setup/create-provider-dialog"} alt={"Create Email Provider"} />
...
- All email provider and recipient changes are recorded in the [Audit Log](/docs/tools/audit-logs).
