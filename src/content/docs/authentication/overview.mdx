...
See [OIDC Settings](/authentication/oidc-settings) for every configuration option, claim mappings, group mapping, and example configurations.
...
Yes. Use [Group Mapping](/authentication/oidc-settings#group-mapping) to map provider groups to Grimmory permissions and library access.
