...
<DocsImage src={"/img/authentication/authentik/create-application"} alt={"Create Application"} />
Fill in the application details:

<DocsImage src={"/img/authentication/authentik/application-details"} alt={"Application Configuration"} />
...
<DocsImage src={"/img/authentication/authentik/provider-type"} alt={"Choose Provider"} />
Choose **OAuth2/OpenID Provider** and click **Next**.

### Configure the Provider

<DocsImage src={"/img/authentication/authentik/provider-settings"} alt={"Configure Provider"} />
...
<DocsImage src={"/img/authentication/authentik/redirect-uris"} alt={"Redirect URIs"} />
...
<DocsImage src={"/img/authentication/authentik/oauth-scopes"} alt={"OAuth Scopes"} />
...
<DocsImage src={"/img/authentication/authentik/user-bindings"} alt={"Configure Bindings"} />
...
<DocsImage src={"/img/authentication/authentik/providers-list"} alt={"Provider List"} />
<DocsImage src={"/img/authentication/authentik/provider-credentials"} alt={"Provider Credentials"} />
...
<DocsImage src={"/img/authentication/authentik/user-impersonation"} alt={"User Impersonation"} />
...
<DocsImage src={"/img/authentication/authentik/login-page"} alt={"Authentik Login Page"} />
3. Click the **Grimmory** tile. You should be redirected and logged in automatically.

<DocsImage src={"/img/authentication/authentik/grimmory-homepage"} alt={"Grimmory Homepage"} />
