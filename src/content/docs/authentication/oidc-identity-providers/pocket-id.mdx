...
<DocsImage src={"/img/authentication/pocket-id/create-client"} alt={"Create Client"} />
Fill in the client configuration:

<DocsImage src={"/img/authentication/pocket-id/client-details"} alt={"Client Details"} />
| Field | Value | Notes |
|-------|-------|-------|
...
<DocsImage src={"/img/authentication/pocket-id/copy-client-id"} alt={"Copy Client ID"} />
...
<DocsImage src={"/img/authentication/pocket-id/app-card"} alt={"Grimmory App Card"} />
Click the **Grimmory** card. Pocket ID handles the authentication and redirects you to Grimmory.

<DocsImage src={"/img/authentication/pocket-id/login-success"} alt={"Login Success"} />
