...
<ThemeImage src={"/img/dashboard/dashboard-overview.jpg"} alt={"Dashboard Overview"} />
...
<ThemeImage src={"/img/dashboard/dashboard-settings.jpg"} alt={"Dashboard Configuration"} />
