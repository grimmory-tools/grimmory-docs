...
slug: docs/initial-setup
sidebar:
  label: "Set Up Admin User"
  order: 3
---
...
Click **"Add a Library"** to get started. See [Set Up First Library](/docs/library/setup-first-library) for a walkthrough.
