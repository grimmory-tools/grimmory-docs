...
After saving, the library scans your folders automatically. See [Setup First Library](/library/setup-first-library) for a full walkthrough, and [Organization Modes](/library/organization-modes) for how to organize your files.
