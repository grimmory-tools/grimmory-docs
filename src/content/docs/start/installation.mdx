...
:::caution[Security]
If your security needs forbid secrets from being used in environment variables, you may use `SPRING_CONFIG_ADDITIONAL_LOCATION` to read
...
To use this override file Grimmory must have an environment variable `SPRING_CONFIG_ADDITIONAL_LOCATION` added with the value
being the location of your configuration with secrets injected.
:::
