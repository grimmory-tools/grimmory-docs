...
<ThemeImage src={"/img/authors/browse-all-authors.jpg"} alt={"Browse All Authors"} />
### Search and Sort
...
<ThemeImage src={"/img/authors/author-details.jpg"} alt={"Author Details"} />
---
...
<ThemeImage src={"/img/authors/edit-details.jpg"} alt={"Edit Details"} />
**Photo options:**
...
<ThemeImage src={"/img/authors/search-author.jpg"} alt={"Search Author"} />
