...
<DocsImage src={"/img/magic-shelf/magic-shelf-1"} alt={"Magic Shelf Open"} />
Navigate to **Shelves** in the sidebar and click **New Magic Shelf**.

### Step 2: Configure Your Shelf

<DocsImage src={"/img/magic-shelf/magic-shelf-2"} alt={"Magic Shelf Create"} />
...
<DocsImage src={"/img/magic-shelf/magic-shelf-export"} alt={"Copy JSON option in the Magic Shelf context menu"} />
...
<DocsImage src={"/img/magic-shelf/magic-shelf-import-json"} alt={"Pasting JSON into the import text area"} />
The builder validates the JSON and populates the rule tree so you can review or tweak the rules before saving.

<DocsImage src={"/img/magic-shelf/magic-shelf-import-applied"} alt={"Rules populated after applying imported JSON"} />
### Via SQL
