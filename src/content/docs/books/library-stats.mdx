...
<ThemeImage src={"/img/library-stats/library-stats-overview.jpg"} alt={"Library Statistics"} />
...
<ThemeImage src={"/img/library-stats/library-stats-charts.jpg"} alt={"Charts Detail"} />
