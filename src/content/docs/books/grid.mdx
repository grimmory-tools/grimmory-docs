...
<ThemeImage src={"/img/grid/overview.jpg"} alt={"Grid View"} />
---
...
<ThemeImage src={"/img/grid/cover-size-slider.jpg"} alt={"Display Settings"} />
| Setting | Description |
|---------|-------------|
...
<ThemeImage src={"/img/grid/series-expanded.jpg"} alt={"Series Expanded"} />
With collapse on, only one card per series is shown with an overlay count:

<ThemeImage src={"/img/grid/series-collapsed.jpg"} alt={"Series Collapsed"} />
---
...
<ThemeImage src={"/img/grid/sort-dropdown.jpg"} alt={"Sort Options"} />
...
<ThemeImage src={"/img/grid/search-bar.jpg"} alt={"Search"} />
---
...
<ThemeImage src={"/img/grid/sidebar-filters.jpg"} alt={"Sidebar Filters"} />
...
<ThemeImage src={"/img/grid/sidebar-sort-options.jpg"} alt={"Sidebar Sort Options"} />
---
