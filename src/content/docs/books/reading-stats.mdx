...
<ThemeImage src={"/img/reading-stats/reading-stats-completion-race.jpg"} alt={"Completion Race"} />
...
<ThemeImage src={"/img/reading-stats/reading-stats-session-archetypes.jpg"} alt={"Session Archetypes"} />
### Progress & Completion

<ThemeImage src={"/img/reading-stats/reading-stats-survival-length.jpg"} alt={"Survival Curve & Length"} />
...
<ThemeImage src={"/img/reading-stats/reading-stats-book-flow.jpg"} alt={"Book Flow"} />
...
<ThemeImage src={"/img/reading-stats/reading-stats-debt-era.jpg"} alt={"Debt & Era"} />
