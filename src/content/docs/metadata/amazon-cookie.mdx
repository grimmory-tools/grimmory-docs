...
<ThemeImage src={"/img/metadata/amazon-cookie/amazon-cookie-1.jpg"} alt={"Browser developer tools showing the Cookie header in Amazon's request headers"} />
...
<ThemeImage src={"/img/metadata/amazon-cookie/amazon-cookie-2.jpg"} alt={"Grimmory Metadata 1 settings showing the Amazon region dropdown and cookie field"} />
