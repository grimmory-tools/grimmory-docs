...
<ThemeImage src={"/img/metadata/manager/overview.jpg"} alt={"Metadata Manager Overview"} />
Access it from **Settings > Metadata Manager**.

<ThemeImage src={"/img/metadata/manager/access-settings.jpg"} alt={"Access Settings"} />
...
<ThemeImage src={"/img/metadata/manager/select-items.jpg"} alt={"Select Items"} />
<ThemeImage src={"/img/metadata/manager/merge-target.jpg"} alt={"Merge Target"} />
...
<ThemeImage src={"/img/metadata/manager/rename-button.jpg"} alt={"Rename Button"} />
<ThemeImage src={"/img/metadata/manager/rename-input.jpg"} alt={"Rename Input"} />
<ThemeImage src={"/img/metadata/manager/rename-confirm.jpg"} alt={"Rename Confirm"} />
...
<ThemeImage src={"/img/metadata/manager/delete-option.jpg"} alt={"Delete Option"} />
