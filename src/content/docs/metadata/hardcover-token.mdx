...
<ThemeImage src={"/img/metadata/hardcover-api/hardcover-1.jpg"} alt={"Hardcover API Access page showing the Bearer token"} />
...
<ThemeImage src={"/img/metadata/hardcover-api/hardcover-2.jpg"} alt={"Grimmory Metadata 1 settings with the Hardcover token field"} />
