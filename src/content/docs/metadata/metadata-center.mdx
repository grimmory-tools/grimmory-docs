...
<ThemeImage src={"/img/metadata-center/book-details.jpg"} alt={"Metadata Center"} />
:::tip[Display Mode]
...
<ThemeImage src={"/img/metadata-center/files-tab.jpg"} alt={"Files Tab"} />
...
<ThemeImage src={"/img/metadata-center/notes-tab.jpg"} alt={"Notes Tab"} />
...
<ThemeImage src={"/img/metadata-center/reading-sessions-tab.jpg"} alt={"Reading Sessions Tab"} />
| Column | Description |
|--------|-------------|
...
<ThemeImage src={"/img/metadata-center/reviews-tab.jpg"} alt={"Reviews Tab"} />
...
<ThemeImage src={"/img/metadata-center/edit-metadata.jpg"} alt={"Edit Metadata"} />
### Fields
...
<ThemeImage src={"/img/metadata-center/search-metadata.jpg"} alt={"Search Metadata"} />
### Searching
...
<ThemeImage src={"/img/metadata-center/search-metadata-compare.jpg"} alt={"Search Metadata Comparison"} />
...
<ThemeImage src={"/img/metadata-center/sidecar.jpg"} alt={"Sidecar"} />
