...
OPDS (Open Publication Distribution System) lets you browse and download books from your Grimmory library using any OPDS-compatible reading app.

Point your app at Grimmory's catalog URL, authenticate, and your full library is available on any device: e-readers, tablets, or phones.
...
<DocsImage src={"/img/opds/opds"} alt={"Grimmory OPDS Configuration page showing server toggles, endpoint URLs, and OPDS user management"} />
...
| App | Platform | Notes |
|-----|----------|-------|
| KOReader | Android, iOS, Linux, Windows | Also supports [progress sync](/docs/integration/koreader) for books downloaded via OPDS |
| Moon+ Reader | Android | |
