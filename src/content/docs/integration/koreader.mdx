...
<ThemeImage src={"/img/koreader/device-settings.jpg"} alt={"Grimmory Settings > Devices page showing KOReader Settings with Enable toggle, API Path, Username, and Password fields with an Edit button"} />
...
<ThemeImage src={"/img/koreader/credentials-setup.jpg"} alt={"KOReader Settings with sync enabled, API path populated, username and password filled in, and Save button"} />
:::note[Permissions]
...
<ThemeImage src={"/img/koreader/user-permissions.jpg"} alt={"Settings > Users page showing the user list with permission columns including KOReader Sync"} />
---
...
<ThemeImage src={"/img/koreader/settings-menu.jpg"} alt={"KOReader tools menu showing Progress sync option"} />
2. Tap **Custom sync server** and enter the API path you copied from Grimmory

<ThemeImage src={"/img/koreader/custom-sync-server.jpg"} alt={"KOReader Custom sync server dialog with the Grimmory API URL entered"} />
3. Tap **Register / Login**, enter the username and password you set in Grimmory, and tap **Login**

<ThemeImage src={"/img/koreader/login-credentials.jpg"} alt={"KOReader login dialog with username and password fields and Login button"} />
...
<ThemeImage src={"/img/koreader/push-pull-options.jpg"} alt={"KOReader Progress sync menu showing Push and Pull options, along with auto-sync settings"} />
...
<ThemeImage src={"/img/koreader/matching-method.jpg"} alt={"KOReader Document matching method menu"} />
<ThemeImage src={"/img/koreader/binary-matching.jpg"} alt={"Binary option selected: \"Only identical files will be kept in sync\""} />
:::tip[Auto Sync]
...
<ThemeImage src={"/img/koreader/synced-progress.jpg"} alt={"Book detail page for Digital Fortress showing KOReader Progress at 21.1% alongside Grimmory Progress and other metadata"} />
