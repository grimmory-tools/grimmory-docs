...
<ThemeImage src={"/img/kobo/device-settings.jpg"} alt={"Grimmory Settings > Devices page showing the Kobo Sync Token and Regenerate Token button"} />
...
<ThemeImage src={"/img/kobo/config-file-location.jpg"} alt={"Finder showing the KOBOeReader drive with the .kobo hidden folder visible"} />
...
<ThemeImage src={"/img/kobo/config-before.jpg"} alt={"The original Kobo eReader.conf showing api_endpoint pointing to storeapi.kobo.com"} />
...
<ThemeImage src={"/img/kobo/config-after.jpg"} alt={"The modified Kobo eReader.conf with api_endpoint pointing to the Grimmory instance"} />
...
<ThemeImage src={"/img/kobo/assign-shelf.jpg"} alt={"Book card context menu showing Assign Shelf option with shelf list"} />
3. Repeat for all books you want on the device. The Kobo shelf shows everything queued for sync.

<ThemeImage src={"/img/kobo/shelf-with-books.jpg"} alt={"Grimmory's Kobo shelf view showing 7 books ready to sync"} />
4. On your Kobo, go to **My Books**, tap the sync icon in the top-right corner, and tap **Sync now**

<ThemeImage src={"/img/kobo/sync-button.jpg"} alt={"Kobo device showing the Sync complete dialog with Sync now button"} />
5. Your Grimmory books appear on the device, ready to read

<ThemeImage src={"/img/kobo/synced-books.jpg"} alt={"Kobo device My Books screen showing the synced books from Grimmory"} />
---
...
<ThemeImage src={"/img/kobo/remove-menu.jpg"} alt={"Kobo context menu on a book showing Read now, View Details, Add to collection, Mark as finished, and Remove options"} />
2. Select **Remove from My Books** and tap **Remove**

<ThemeImage src={"/img/kobo/remove-confirm.jpg"} alt={"Kobo removal dialog with Remove download and Remove from My Books options"} />
3. Tap **Sync now** to push the change back to Grimmory

<ThemeImage src={"/img/kobo/sync-after-removal.jpg"} alt={"Kobo after removal showing one fewer book, with Sync complete dialog"} />
The book is removed from your Kobo shelf in Grimmory but stays in your library. It's not deleted, just unsynced.

<ThemeImage src={"/img/kobo/shelf-after-removal.jpg"} alt={"Grimmory Kobo shelf after sync showing the book has been removed from the shelf"} />
### From Grimmory
...
<ThemeImage src={"/img/kobo/synced-progress.jpg"} alt={"Book detail page showing Kobo Progress at 11% alongside other metadata"} />
...
<ThemeImage src={"/img/kobo/user-permissions.jpg"} alt={"Settings > Users page showing the user list with permission columns including Kobo Sync"} />
