...
<DocsImage src={"/img/kobo/config-file-location"} alt={"Finder showing the KOBOeReader drive with the .kobo hidden folder visible"} />
...
<DocsImage src={"/img/kobo/config-before"} alt={"The original Kobo eReader.conf showing api_endpoint pointing to storeapi.kobo.com"} />
...
<DocsImage src={"/img/kobo/config-after"} alt={"The modified Kobo eReader.conf with api_endpoint pointing to the Grimmory instance"} />
...
<DocsImage src={"/img/kobo/sync-button"} alt={"Kobo device showing the Sync complete dialog with Sync now button"} />
5. Your Grimmory books appear on the device, ready to read

<DocsImage src={"/img/kobo/synced-books"} alt={"Kobo device My Books screen showing the synced books from Grimmory"} />
---
...
<DocsImage src={"/img/kobo/remove-menu"} alt={"Kobo context menu on a book showing Read now, View Details, Add to collection, Mark as finished, and Remove options"} />
2. Select **Remove from My Books** and tap **Remove**

<DocsImage src={"/img/kobo/remove-confirm"} alt={"Kobo removal dialog with Remove download and Remove from My Books options"} />
3. Tap **Sync now** to push the change back to Grimmory

<DocsImage src={"/img/kobo/sync-after-removal"} alt={"Kobo after removal showing one fewer book, with Sync complete dialog"} />
