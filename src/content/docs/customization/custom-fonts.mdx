...
2. Click the **Add New Font** button
   ...
   <ThemeImage src={"/img/custom-fonts/font-library.jpg"} alt={"Custom Fonts Tab"} />
3. Click the upload area or drag and drop a font file

   <ThemeImage src={"/img/custom-fonts/upload-dialog.jpg"} alt={"Font Upload Dialog"} />
4. After selecting a file, a preview and name input appear. Enter a display name (or keep the filename).

   <ThemeImage src={"/img/custom-fonts/file-preview.jpg"} alt={"Font Selected"} />
...
<ThemeImage src={"/img/custom-fonts/font-collection.jpg"} alt={"Font Collection"} />
...
<ThemeImage src={"/img/custom-fonts/global-setting.jpg"} alt={"Global Font Setting"} />
### Per-Book Setting
...
<ThemeImage src={"/img/custom-fonts/per-book-setting.jpg"} alt={"Per-Book Font Setting"} />
:::note
