...
<DocsImage src={"/img/icons/icon-picker"} alt={"Create New Library dialog showing the Library Icon field with a \"Choose an Icon\" button"} />
...
<DocsImage src={"/img/icons/prime-icons"} alt={"Choose an Icon modal on the Prime Icons tab, showing a search bar and a grid of built-in icons"} />
---
...
<DocsImage src={"/img/icons/custom-icons"} alt={"SVG Icons tab showing a search bar, a grid of uploaded custom icons, and a \"Drag here to delete icon\" trash zone at the bottom-right"} />
...
<DocsImage src={"/img/icons/add-svg"} alt={"Add SVG Icon tab with a name field (\"king\"), an SVG code textarea with pasted content, a live preview showing the rendered icon, and a Save SVG button"} />
