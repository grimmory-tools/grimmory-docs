...
<ThemeImage src={"/img/epub-reader/epub-reader-overview.jpg"} alt={"EPUB Reader Overview"} />
...
<ThemeImage src={"/img/epub-reader/epub-reader-navigation.jpg"} alt={"Navigation Popover"} />
...
<ThemeImage src={"/img/epub-reader/epub-reader-toc.jpg"} alt={"Table of Contents"} />
...
<ThemeImage src={"/img/epub-reader/epub-reader-notes.jpg"} alt={"Notes Panel"} />
...
<ThemeImage src={"/img/epub-reader/epub-reader-quick-settings.jpg"} alt={"Quick Settings"} />
...
<ThemeImage src={"/img/epub-reader/epub-reader-theme.jpg"} alt={"Theme Settings"} />
...
<ThemeImage src={"/img/epub-reader/epub-reader-typography.jpg"} alt={"Typography Settings"} />
...
<ThemeImage src={"/img/epub-reader/epub-reader-layout.jpg"} alt={"Layout Settings"} />
| Setting | Range | Default |
|---|---|---|
