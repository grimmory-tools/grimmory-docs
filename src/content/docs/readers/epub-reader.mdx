...
Font family options: **Publisher's** (uses the book's embedded fonts), **Serif**, **Sans-Serif**, **Monospace**, **Cursive**, and any [custom fonts](/docs/tools/custom-fonts) you've uploaded.
...
Reading sessions are tracked in the background: each time you open the reader, a session is recorded with start/end times and positions. These sessions appear in the book's [Metadata Center](/docs/metadata/metadata-center) under the Reading Sessions tab.
