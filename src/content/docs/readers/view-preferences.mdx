...
<ThemeImage src={"/img/view-preferences/library-shelf-view-sort.jpg"} alt={"Library and Shelf View & Sort Preferences"} />
### Default Preferences
...
<ThemeImage src={"/img/view-preferences/filter-preferences.jpg"} alt={"Filter Preferences"} />
### Filter Mode
...
<ThemeImage src={"/img/view-preferences/sidebar-sorting.jpg"} alt={"Sidebar Sorting Preferences"} />
...
<ThemeImage src={"/img/view-preferences/metadata-series-view.jpg"} alt={"View Preferences"} />
| Setting | Options | Default | Description |
|---------|---------|---------|-------------|
...
<ThemeImage src={"/img/view-preferences/layout.jpg"} alt={"Layout"} />
