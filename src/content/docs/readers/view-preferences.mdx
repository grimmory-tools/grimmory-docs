...
- See [Grid View](/docs/book-browser/grid) and [Table View](/docs/book-browser/table) for details on how each view mode works.
- See [Reader Preferences](/docs/reader-preferences) for configuring reading experience settings.
