...
PDF reader settings can be saved globally (applied to all PDFs) or per book. The scope is controlled in [Reader Preferences](/docs/reader-preferences). Per-book settings override global defaults when enabled.
