...
<ThemeImage src={"/img/cbx-reader/cbx-reader-overview.jpg"} alt={"Comic Reader Overview"} />
...
<ThemeImage src={"/img/cbx-reader/cbx-reader-pages.jpg"} alt={"Sidebar with Pages"} />
...
<ThemeImage src={"/img/cbx-reader/cbx-reader-settings.jpg"} alt={"Comic Reader Settings"} />
### Fit Mode
...
<ThemeImage src={"/img/cbx-reader/cbx-reader-notes.jpg"} alt={"Note Dialog"} />
...
<ThemeImage src={"/img/cbx-reader/cbx-reader-shortcuts.jpg"} alt={"Keyboard Shortcuts"} />
### Navigation
