...
<ThemeImage src={"/img/physical-books/library-menu.jpg"} alt={"Library Context Menu"} />
---
...
<ThemeImage src={"/img/physical-books/add-dialog.jpg"} alt={"Add Physical Book Dialog"} />
**Fields:**
...
<ThemeImage src={"/img/physical-books/isbn-import-menu.jpg"} alt={"Import ISBNs option in the library context menu"} />
...
<ThemeImage src={"/img/physical-books/isbn-import-dialog.jpg"} alt={"Import ISBNs dialog showing parsed and validated ISBNs"} />
...
<ThemeImage src={"/img/physical-books/isbn-import-progress.jpg"} alt={"Import in progress with real-time metadata lookup"} />
...
<ThemeImage src={"/img/physical-books/isbn-import-complete.jpg"} alt={"Import complete summary showing all created books"} />
---
