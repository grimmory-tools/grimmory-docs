...
slug: docs/library/physical-books
sidebar:
...
Use this to see your entire physical collection at a glance, or combine it with other rules (e.g., all physical books by a specific author).

See [Magic Shelf](/docs/magic-shelf) for more on creating rule-based shelves.
