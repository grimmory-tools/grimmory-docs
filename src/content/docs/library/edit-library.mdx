...
<ThemeImage src={"/img/edit-library/sidebar-menu.jpg"} alt={"Sidebar Menu"} />
<ThemeImage src={"/img/edit-library/header-menu.jpg"} alt={"Header Menu"} />
---
...
<ThemeImage src={"/img/edit-library/edit-form.jpg"} alt={"Edit Form"} />
---
