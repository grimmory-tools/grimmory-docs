---
title: "Set Up First Library"
slug: docs/library/setup-first-library
sidebar:
  label: "Set Up First Library"
  order: 1
---
...
- Set up [metadata providers](/docs/metadata/metadata-fetch-configuration) for richer book information
- Learn about [library management](/docs/library/edit-library) for rescanning, metadata refresh, and deletion
- Read about [organization modes](/docs/library/organization-modes) for optimal file organization
