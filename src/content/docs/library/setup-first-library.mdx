...
<ThemeImage src={"/img/first-library/click-add-a-library.jpg"} alt={"Empty Dashboard"} />
This opens the library creation dialog.

<ThemeImage src={"/img/first-library/new-library-dialog.jpg"} alt={"New Library Dialog"} />
---
...
<ThemeImage src={"/img/first-library/library-folder-picker.jpg"} alt={"Folder Picker"} />
...
<ThemeImage src={"/img/first-library/library-processing.jpg"} alt={"Library Processing"} />
