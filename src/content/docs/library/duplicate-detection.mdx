...
slug: docs/library/duplicate-detection
sidebar:
...
<DocsImage src={"/img/duplicate-detection/library-menu"} alt={"Library Context Menu"} />
...
<DocsImage src={"/img/duplicate-detection/find-duplicates-dialog"} alt={"Find Duplicates Dialog"} />
### Presets
